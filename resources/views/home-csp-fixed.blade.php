    ...
    <section class="py-12 bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div x-data="improvedConverter" class="space-y-6">
                ...
                <!-- Multi-Output Preview Grid - CSP COMPLIANT -->
                                ...
                                <div class="group relative bg-white dark:bg-gray-800 rounded-lg p-3 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-600 transition-all cursor-pointer"
                                    ...
                                    <div class="flex items-center justify-between mb-2">
                                        <h4 class="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider" 
                                            x-text="getPreviewLabel(index)"></h4>
                                        <div class="opacity-0 group-hover:opacity-100 transition-opacity">
                                            <template x-if="shouldShowCopyText(index)">
                                                <span class="text-xs text-blue-600 dark:text-blue-400">Copy</span>
                                            </template>
                                            <template x-if="isPreviewCopied(index)">
                                    ...
                                    <div class="bg-gray-50 dark:bg-gray-900 rounded px-3 py-2 min-h-[60px]">
                                        <span x-text="getPreviewOutput(index)" 
                ...
                <!-- Empty State -->
                <template x-if="noInput">
                    <div class="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-700">
