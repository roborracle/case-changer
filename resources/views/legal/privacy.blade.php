...
<div class="min-h-screen" style="background-color: var(--bg-secondary);">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="rounded-xl shadow-sm" style="background-color: var(--bg-primary); border: 1px solid var(--border-primary);">
            <div class="p-8">
                <h1 class="text-3xl font-bold mb-8" style="color: var(--text-primary);">Privacy Policy</h1>
                ...
                <div class="prose prose-lg max-w-none" style="color: var(--text-secondary);">
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">1. Information We Don't Collect</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">2. Information We Collect</h2>
                    <p>We collect minimal, anonymous data to improve our service:</p>
                    
                    <h3 class="text-xl font-semibold mt-6 mb-3" style="color: var(--text-primary);">2.1 Analytics Data</h3>
                    ...
                    <h3 class="text-xl font-semibold mt-6 mb-3" style="color: var(--text-primary);">2.2 Technical Data</h3>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">3. Cookies</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">4. Data Security</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">5. Third-Party Services</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">6. Children's Privacy</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">7. Your Rights</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">8. Changes to This Policy</h2>
                    <p>We may update this Privacy Policy from time to time. Changes will be posted on this page with an updated revision date.</p>
                    
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">9. Contact Us</h2>
