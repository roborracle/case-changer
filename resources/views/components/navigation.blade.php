...
<nav class="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700 sticky top-0 z-40">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:ml-10 md:flex md:items-center md:space-x-1">
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute left-0 mt-2 w-screen max-w-4xl shadow-xl rounded-lg border bg-primary hidden"
                            >
                            <div class="p-6">
                    ...
                    <div class="relative">
                        <button class="inline-flex items-center h-full px-4 py-2 text-sm font-medium rounded-md transition-colors text-secondary">
                        Popular
                        <svg class="ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                        ...
                        <div class="absolute right-0 mt-2 w-64 shadow-xl rounded-lg border bg-primary hidden"
                            >
                            <div class="p-2">
            ...
            <div class="flex items-center space-x-2">
                ...
                <button class="p-2 rounded-md transition-colors text-secondary">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button class="md:hidden p-2 rounded-md transition-colors text-secondary">
    ...
    <div class="md:hidden border-t shadow-lg bg-primary hidden"
        >
        <div class="px-4 py-3 space-y-1">
            <a href="/" class="block px-4 py-2.5 text-base font-medium rounded-md transition-colors text-secondary">Home</a>
            <span class="block px-4 py-2.5 text-base font-medium rounded-md transition-colors text-secondary" >All Tools</span>
            <span class="block px-4 py-2.5 text-base font-medium rounded-md transition-colors text-secondary" >Quick Convert</span>
            ...
            <div class="pt-3 mt-3 border-t">
                ...
                <span class="block px-4 py-2 text-sm rounded-md transition-colors text-secondary" >
                {{ $category['title'] }}
            ...
            <div class="p-6">
                ...
                <div class="border-t pt-4">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <span class="px-3 py-2 text-sm rounded-lg transition-colors text-secondary" >UPPERCASE</span>
                        <span class="px-3 py-2 text-sm rounded-lg transition-colors text-secondary" >lowercase</span>
                        <span class="px-3 py-2 text-sm rounded-lg transition-colors text-secondary" >camelCase</span>
                        <span class="px-3 py-2 text-sm rounded-lg transition-colors text-secondary" >snake_case</span>
                    </div>
                </div>
            </div>
        </div>
