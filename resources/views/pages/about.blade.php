...
<div class="min-h-screen" style="background-color: var(--bg-secondary);">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="rounded-xl shadow-sm" style="background-color: var(--bg-primary); border: 1px solid var(--border-primary);">
            <div class="p-8">
                <h1 class="text-3xl font-bold mb-8" style="color: var(--text-primary);">About Case Changer Pro</h1>
                ...
                <div class="prose prose-lg max-w-none" style="color: var(--text-secondary);">
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">Why Case Changer Pro?</h2>
                    
                    <div class="grid md:grid-cols-2 gap-6 my-8">
                        <div class="p-4 rounded-lg" style="background-color: var(--bg-secondary);">
                            <h3 class="text-lg font-semibold mb-2" style="color: var(--text-primary);">🚀 Lightning Fast</h3>
                            <p>All transformations happen instantly in your browser. No server delays, no waiting.</p>
                        </div>
                        
                        <div class="p-4 rounded-lg" style="background-color: var(--bg-secondary);">
                            <h3 class="text-lg font-semibold mb-2" style="color: var(--text-primary);">🔒 100% Private</h3>
                            <p>Your text never leaves your device. We don't store, log, or see what you transform.</p>
                        </div>
                        
                        <div class="p-4 rounded-lg" style="background-color: var(--bg-secondary);">
                            <h3 class="text-lg font-semibold mb-2" style="color: var(--text-primary);">📱 Works Everywhere</h3>
                            <p>Responsive design that works perfectly on desktop, tablet, and mobile devices.</p>
                        </div>
                        
                        <div class="p-4 rounded-lg" style="background-color: var(--bg-secondary);">
                            <h3 class="text-lg font-semibold mb-2" style="color: var(--text-primary);">💰 Completely Free</h3>
                            <p>No subscriptions, no limits, no sign-ups. Just free tools that work.</p>
                        </div>
                    </div>
                    
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">Our Tools</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">Who Uses Case Changer Pro?</h2>
                    
                    <div class="space-y-4 my-6">
                        <div>
                            <h3 class="text-lg font-semibold" style="color: var(--text-primary);">👨‍💻 Developers</h3>
                            <p>Convert between variable naming conventions, format code, encode/decode data</p>
                        </div>
                        
                        <div>
                            <h3 class="text-lg font-semibold" style="color: var(--text-primary);">✍️ Writers & Editors</h3>
                            <p>Format titles, apply style guides, clean up text, ensure consistency</p>
                        </div>
                        
                        <div>
                            <h3 class="text-lg font-semibold" style="color: var(--text-primary);">🎓 Students & Academics</h3>
                            <p>Format citations, apply academic styles, prepare assignments</p>
                        </div>
                        
                        <div>
                            <h3 class="text-lg font-semibold" style="color: var(--text-primary);">📱 Social Media Creators</h3>
                            <p>Generate unique text styles, create eye-catching posts, stand out online</p>
                        </div>
                    </div>
                    
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">Our Commitment</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4" style="color: var(--text-primary);">Get in Touch</h2>
