    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('conversions.category', $slug) }}" 
               class="group rounded-lg p-6 transition-all duration-200 hover:shadow-lg" 
               style="background-color: var(--bg-primary); border: 1px solid var(--border-primary);"
               onmouseover="this.style.borderColor = 'var(--accent-primary)'; this.style.boxShadow = '0 10px 15px -3px var(--shadow-primary), 0 4px 6px -2px var(--shadow-secondary)';"
               onmouseout="this.style.borderColor = 'var(--border-primary)'; this.style.boxShadow = '';">
                <div class="flex items-start justify-between mb-4">
                    <div class="p-3 rounded-lg transition-colors" style="background: linear-gradient(135deg, var(--bg-secondary), var(--bg-tertiary));">
                ...
                <h2 class="text-xl font-semibold mb-2 group-hover:text-blue-600 transition-colors" style="color: var(--text-primary);">
                    {{ $category['title'] }}
                </h2>
        ...
        <div class="mt-16 rounded-xl p-8" style="background-color: var(--bg-secondary);">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                <a href="{{ route('conversions.tool', ['case-conversions', 'uppercase']) }}" 
                   class="px-4 py-2 rounded-lg text-center transition-all"
                   style="background-color: var(--bg-primary); border: 1px solid var(--border-primary); color: var(--text-primary);"
                   onmouseover="this.style.borderColor = 'var(--accent-primary)'; this.style.boxShadow = '0 4px 6px -1px var(--shadow-secondary)';"
                   onmouseout="this.style.borderColor = 'var(--border-primary)'; this.style.boxShadow = '';">
