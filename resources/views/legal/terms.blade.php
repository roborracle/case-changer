...
<div class="min-h-screen bg-secondary" >
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="rounded-xl shadow-sm bg-primary border" >
            <div class="p-8">
                <h1 class="text-3xl font-bold mb-8 text-primary" >Terms of Service</h1>

                <div class="prose prose-lg max-w-none text-secondary" >
                    <p class="text-sm mb-6 text-tertiary" >Last updated: {{ date('F d, Y') }}</p>

                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >1. Acceptance of Terms</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >2. Description of Service</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >3. Privacy and Data</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >4. Acceptable Use</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >5. Intellectual Property</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >6. Limitation of Liability</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >7. Changes to Terms</h2>
                    ...
                    <h2 class="text-2xl font-semibold mt-8 mb-4 text-primary" >8. Contact Information</h2>
