    ...
    <div class="min-h-screen flex items-center justify-center p-8">
        <div class="max-w-4xl w-full">
            <div class="text-center mb-12">
                <h1 class="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 mb-4">
                    Case Changer Pro
                </h1>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <a href="{{ route('modern-case-changer') }}" class="group">
                    <div class="bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-purple-500/30 p-8 transition-all duration-300 hover:border-purple-400 hover:bg-gray-900/70 hover:transform hover:scale-105">
                        <div class="mb-4">
                            <span class="inline-block px-3 py-1 text-xs font-medium bg-purple-600/20 text-purple-300 rounded-full border border-purple-500/30">
                                Recommended
                            </span>
                        </div>
                        ...
                        <div class="mt-6 flex items-center text-purple-400 group-hover:text-purple-300">
            ...
            <div class="mt-12 text-center">
                <a href="{{ route('conversions.index') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 transition-all">
