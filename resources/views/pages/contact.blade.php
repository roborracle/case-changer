...
<div class="min-h-screen bg-secondary" >
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="rounded-xl shadow-sm bg-primary border" >
            <div class="p-8">
                <h1 class="text-3xl font-bold mb-8 text-primary" >Contact Us</h1>
                ...
                <div class="prose prose-lg max-w-none text-secondary" >
                    ...
                    <h2 class="text-2xl font-semibold mt-12 mb-6 text-primary" >Frequently Asked Questions</h2>

                    <div class="space-y-6">
                        <div>
                            <h3 class="text-lg font-semibold mb-2 text-primary" >How quickly will I get a response?</h3>
                        ...
                        <div>
                            <h3 class="text-lg font-semibold mb-2 text-primary" >Can I request a custom tool?</h3>
                        ...
                        <div>
                            <h3 class="text-lg font-semibold mb-2 text-primary" >Do you offer an API?</h3>
                            <p>We're currently developing an API for developers. Join our mailing list to be notified when it launches.</p>
                        </div>

                        <div>
                            <h3 class="text-lg font-semibold mb-2 text-primary" >Is there a mobile app?</h3>
                    ...
                    <div class="mt-12 p-6 rounded-lg bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                        ...
                        <form class="flex gap-3">
                            ...
                            class="flex-1 px-4 py-2 rounded-lg bg-primary text-primary border"
                            >
                            <button type="submit"
